...
import com.rxzone.Activities.Fragments.AddPostFragment.AllPostMainFragment;
...
public class HomeActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initializeViews(HomeActivity.this);
...
//        navigationView.getMenu().getItem(3).setActionView(R.layout.menu_dot);
    ...
    private Fragment getHomeFragment() {
        switch (navItemIndex) {
            ...
            case 0:
                // home
                AllPostMainFragment homeFragment = new AllPostMainFragment();
                return homeFragment;
            case 1:
                // photos
                MoviesFragment photosFragment = new MoviesFragment();
            ...
            case 3:
                ...
                AddPostFragment notificationsFragment = new AddPostFragment();
                return notificationsFragment;

            case 4:
                // settings fragment
                AllPostMainFragment settingsFragment = new AllPostMainFragment();
                return settingsFragment;
            default:
                return new AllPostMainFragment();
        }
    }
